...
#define RD_DQS_GATE	((emif == 0) ? 0x12A : 0x13E)
#define RD_DQS		((emif == 0) ? 0x3B : 0x3A)
#define WR_DQS		((emif == 0) ? 0xA6 : 0x97)
#endif
...
#if defined(CONFIG_TI816X_DDR3_SW_LEVELING)
/* These values are obtained from the CCS app */
#define RD_DQS_GATE	((emif == 0) ? 0x13E : 0x13E)
#define RD_DQS		((emif == 0) ? 0x3A : 0x3A)
...
// DM8168
#define RD_DQS_GATE	((emif == 0) ? 0x142 : 0x142)
#define RD_DQS		((emif == 0) ? 0x3C : 0x3C)
#define WR_DQS		((emif == 0) ? 0x98 : 0x98)
