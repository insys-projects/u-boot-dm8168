...
#ifdef CONFIG_TI814X
#define LED1_RED           (CTRL_BASE + 0x08F4)
#define LED1_GREEN         (CTRL_BASE + 0x08F8)
#define LED2_RED           (CTRL_BASE + 0x08FC)
#define LED2_GREEN         (CTRL_BASE + 0x0900)
#define LED1_RED_PIN       (1<<7)
#define LED1_GREEN_PIN     (1<<8)
#define LED2_RED_PIN       (1<<9)
#define LED2_GREEN_PIN     (1<<10)
#define LED_PINS           (LED1_RED_PIN | LED1_GREEN_PIN | LED2_RED_PIN | LED2_GREEN_PIN)
#endif
