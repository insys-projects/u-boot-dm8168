 ...
 */
#define USE_WR_DQS_FORCE	0x9A
#define USE_RD_DQS_FORCE	0x34
#define USE_RD_GATE_FORCE	0x12F
...
#define RD_DQS_GATE	((emif == 0) ? 0xF7 : 0xF7)
#define RD_DQS		((emif == 0) ? 0x3E : 0x3E)
#define WR_DQS		((emif == 0) ? 0x77 : 0x77)
#endif
...
#define RD_DQS_GATE	((emif == 0) ? 0x115 : 0x115)
#define RD_DQS		((emif == 0) ? 0x3b : 0x3b)
#define WR_DQS		((emif == 0) ? 0x80 : 0x80)
...
#if defined(CONFIG_TI816X_DDR3_SW_LEVELING)
/* These values are obtained from the CCS app */
#define RD_DQS_GATE	((emif == 0) ? 0x102 : 0x102)
#define RD_DQS		((emif == 0) ? 0x3D : 0x3D)
#define WR_DQS		((emif == 0) ? 0x65 : 0x65)

// for rev. 1.2
//#define RD_DQS_GATE	((emif == 0) ? 0x122 : 0x122)
//#define RD_DQS		((emif == 0) ? 0x49 : 0x49)
//#define WR_DQS		((emif == 0) ? 0x85 : 0x85)
