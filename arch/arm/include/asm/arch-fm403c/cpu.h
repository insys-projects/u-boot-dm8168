...
#define LED1_RED			(CTRL_BASE + 0xb28)
#define LED1_GREEN			(CTRL_BASE + 0xb2c)
#define LED2_RED			(CTRL_BASE + 0xb30)
#define LED2_GREEN			(CTRL_BASE + 0xb34)

#define GP0_PIN0			(CTRL_BASE + 0xc88)
#define GP0_PIN1			(CTRL_BASE + 0xc8c)
#define GP0_PIN2			(CTRL_BASE + 0xc90)
#define GP0_PIN3			(CTRL_BASE + 0xc9c)

#define TIM7_OUT			(CTRL_BASE + 0xb34)	/* a12 */
#define UART1_RXD			(CTRL_BASE + 0xad0)	/* a13 */
#define UART1_TXD			(CTRL_BASE + 0xad4)	/* a14 */
