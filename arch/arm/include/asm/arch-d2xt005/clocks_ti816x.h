...
#define ARM_PLL_1200 /* Keep ARM@1200 MHz as default for DVR RDK in sync with CYG2 configuration */

#define FAPLL_K			8
#define SYSCLK_2_DIV		1
#define OSC_FREQ		27

#ifdef CONFIG_UD8168_DVR
/* Values supported 400,531,675,796 */
#ifdef CONFIG_TI816X_DDR3_400
#define DDR_PLL_400
#endif
#ifdef CONFIG_TI816X_DDR3_531
#define DDR_PLL_531
#endif
#ifdef CONFIG_TI816X_DDR3_675
#define DDR_PLL_675
#endif
...
/* DSP -> 1000 MHz*/
#define MAIN_INTFREQ1		0xC
#define MAIN_FRACFREQ1		0x189374
...
/* L3 FAST -> 549.8181818 MHz, Ducati M3 - 274.9090 MHz, DSS - 274 MHz, L3 Medium - 274 MHz*/
#define MAIN_INTFREQ4		11 	        // 12 - for 250 MHz 
#define MAIN_FRACFREQ4		0x0         // 0x189374	- for 250 MHz 
...
#define DDR_INTFREQ3		13  /* correct value is decimal 13 */
