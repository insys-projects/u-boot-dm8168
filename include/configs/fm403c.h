...
# define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "script_addr=0xC0900000\0" \
        "loadbootscript=dhcp; setenv serverip 192.168.1.34; tftp ${script_addr} boot.scr;\0" \
        "bootscript= echo Running bootscript from fm403c.h to set the ENV...; " \
...
# define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "loadaddr=0xC1000000\0" \
        "script_addr=0xC0900000\0" \
        "bootargs=console=ttyO2,115200n8 rootwait mem=176M earlyprintk root=/dev/ram0 rw initrd=0xC2000000,32M ramdisk_size=32768 ip=dhcp\0"

#define CONFIG_BOOTCOMMAND \
        "sf probe 0; sf read 0xC1000000 0x40000 0x300000; sf read 0xC2000000 0x440000 0x400000; bootm 0xC1000000"
*/
...
#define CONFIG_SYS_PROMPT		"FM403C#"
...
//# define PHY_KSZ9021GN                  (0x00221612)
#endif
...
#  define SPI_FLASH_ERASE_SIZE		(256 * 1024) /* sector size of SPI flash */
#  define CONFIG_SYS_ENV_SECT_SIZE	(8 * 1024) /* env size */
#  define CONFIG_ENV_SECT_SIZE		(CONFIG_SYS_ENV_SECT_SIZE)
#  define CONFIG_ENV_OFFSET		(1 * SPI_FLASH_ERASE_SIZE)
#  define CONFIG_ENV_ADDR		(CONFIG_ENV_OFFSET)
#  define CONFIG_SYS_MAX_FLASH_SECT	(64) /* no of sectors in SPI flash */
