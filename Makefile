...
#		cp u-boot.bin-minimal u-boot.bin
		$(obj)tools/mkimage -T tiimage \
		-e $(TI_LOAD_ADDR) -n $(TI_DEVICE) -d $< $(obj)$(TI_IMAGE)
		cp u-boot.noxip.bin $(HOME)/tftpboot
		cp u-boot.noxip.bin.spi $(HOME)/tftpboot
...
ifneq (,$(findstring d2xt005, $(INSYS_BOARD)))

$(INSYS_BOARD)_config	\
$(INSYS_BOARD)_config_nand	\
$(INSYS_BOARD)_config_spi	\
$(INSYS_BOARD)_min_ocmc:	unconfig
	@mkdir -p $(obj)include
	@echo "#define CONFIG_TI81XX"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI816X"	>>$(obj)include/config.h
	@if [ "$(findstring _nand,$@)" ] ; then \
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) NAND build with ENV in NAND..." ; \
	elif [ "$(findstring _spi,$@)" ] ; then \
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_SPI_ENV"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_TI81XX_SPI_BOOT"	>>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) SPI build with ENV in SPI..." ; \
	elif [ "$(findstring _ocmc,$@)" ] ; then \
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_MINIMAL"    >>$(obj)include/config.h ; \
		echo "TEXT_BASE = 0x40410000" >>$(obj)board/insys/$(INSYS_BOARD)/config.tmp; \
		echo "Setting up $(INSYS_BOARD) minimal build..." ; \
	else	\
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_NAND_ENV"    >>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) default build with NAND..." ; \
	fi;
...
ifneq (,$(findstring d2xt006, $(INSYS_BOARD)))
...
$(INSYS_BOARD)_min_ocmc:	unconfig
	...
	@echo "#define CONFIG_TI81XX"	>>$(obj)include/config.h
	@echo "#define CONFIG_TI816X"	>>$(obj)include/config.h
	@echo "#define D2XT006_BOARD"	>>$(obj)include/config.h
	@if [ "$(findstring _spi,$@)" ] ; then \
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_SPI_ENV"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_TI81XX_SPI_BOOT"	>>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) SPI build with ENV in SPI..." ; \
		...
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_MINIMAL"    >>$(obj)include/config.h ; \
		echo "TI_IMAGE = u-boot.min.spi" >>$(obj)board/insys/$(INSYS_BOARD)/config.tmp; \
		echo "TEXT_BASE = 0x40410000" >>$(obj)board/insys/$(INSYS_BOARD)/config.tmp; \
		echo "Setting up $(INSYS_BOARD) minimal build..." ; \
	else	\
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_SPI_ENV"    >>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) default build with SPI..." ; \
	fi;
	@$(MKCONFIG) -a $(INSYS_BOARD) arm arm_cortexa8 $(INSYS_BOARD) insys $(INSYS_BOARD)
...
ifneq (,$(findstring d2xt007, $(INSYS_BOARD)))
...
ifneq (,$(findstring fm403c, $(INSYS_BOARD)))

$(INSYS_BOARD)_config	\
$(INSYS_BOARD)_config_spi	\
$(INSYS_BOARD)_config_sd	\
$(INSYS_BOARD)_min_ocmc	\
$(INSYS_BOARD)_min_sd: unconfig
	...
	@if [ "$(findstring _spi,$@)" ] ; then \
		...
		echo "Setting up $(INSYS_BOARD) SD boot minimal build..." ; \
	elif [ "$(findstring _min_ocmc,$@)" ] ; then \
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_MINIMAL"    >>$(obj)include/config.h ; \
		echo "TEXT_BASE = 0x40410000" >>$(obj)board/insys/$(INSYS_BOARD)/config.tmp; \
		echo "Setting up $(INSYS_BOARD) minimal build..." ; \
		...
		echo "#define CONFIG_MMC_ENV"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_TI81XX_VIDEO"    >>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) SD build with ENV in MMC..." ; \
	else	\
		echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
		echo "#define CONFIG_SPI_ENV"    >>$(obj)include/config.h ; \
		echo "Setting up $(INSYS_BOARD) default build with SPI..." ; \
...
#INSYS_BOARD := ku_sscos

ifneq (,$(findstring ku_sscos, $(INSYS_BOARD)))
...
$(INSYS_BOARD)_min_sd:	unconfig
	...
	@if [ "$(findstring _min_,$@)" ] ; then \
		...
		if [ "$(findstring nand,$@)" ] ; then \
			...
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "TI_IMAGE = $(INSYS_BOARD)-u-boot.min.nand" >> $(obj)board/insys/$(INSYS_BOARD)/config.tmp;\
		elif [ "$(findstring spi,$@)" ] ; then \
			echo "#define CONFIG_SPI_BOOT" >>$(obj)include/config.h;\
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_SPI_BOOT"	>>$(obj)include/config.h ; \
			echo "TI_IMAGE = $(INSYS_BOARD)-u-boot.min" >> $(obj)board/insys/$(INSYS_BOARD)/config.tmp;\
		elif [ "$(findstring uart,$@)" ] ; then \
			echo "#define CONFIG_UART_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			...
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_TI81XX_PERIPHERAL_BOOT"	>>$(obj)include/config.h; \
			echo "TI_IMAGE = $(INSYS_BOARD)-u-boot.min.eth" >> $(obj)board/insys/$(INSYS_BOARD)/config.tmp;\
		elif [ "$(findstring sd,$@)" ] ; then \
			echo "#define CONFIG_SD_BOOT"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
			echo "TI_IMAGE = $(INSYS_BOARD)-u-boot.min.sd" >> $(obj)board/insys/$(INSYS_BOARD)/config.tmp;\
		else	\
			echo "#define CONFIG_NAND_BOOT"	>>$(obj)include/config.h ; \
			echo "#define CONFIG_NO_ETH"    >>$(obj)include/config.h ; \
			echo "#define CONFIG_SYS_NO_FLASH"    >>$(obj)include/config.h ; \
